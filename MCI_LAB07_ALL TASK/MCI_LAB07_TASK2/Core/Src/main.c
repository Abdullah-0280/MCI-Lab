...
{
    inputBuffer[buf_index] = new_sample;
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
      ...
      adc_voltage = (adc_raw * VREF) / ADC_MAX;

      /* Apply moving average */
      apply_moving_average(adc_voltage);

      /* Send raw + filtered data */
      sprintf(uart_buf, "%.3f,%.3f\r\n", adc_voltage, filtered_output);
